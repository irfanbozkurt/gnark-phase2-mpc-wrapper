...
./semaphore-mtb p1i 20.ptau 20.ph1
./semaphore-mtb p1i 23.ptau 23.ph1
./semaphore-mtb p1i 26.ptau 26.ph1
...
mv b10t30.r1cs b100t30.r1cs b1000t30.r1cs ../semaphore-mtb/
...
./semaphore-mtb p2n 20.ph1 b10t30.r1cs b10t30c0.ph2

mv b10t30c0.ph2 srs.lag evals ../b10/

./semaphore-mtb p2n 23.ph1 b100t30.r1cs b100t30c0.ph2

mv b100t30c0.ph2 srs.lag evals ../b100/

./semaphore-mtb p2n 26.ph1 b1000t30.r1cs b1000t30c0.ph2
...
Download and build the [`semaphore-mtb`](https://github.com/worldcoin/semaphore-mtb) coordinator tool to perform the contribution:
...
```
./semaphore-mtb p2c b10t30cXX.ph2 b10t30c(XX + 1).ph2
```

```
./semaphore-mtb p2c b100t30cXX.ph2 b100t30c(XX + 1).ph2
```
